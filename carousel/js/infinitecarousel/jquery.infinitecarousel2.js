	...
	$.fn.extend({ 
		infiniteCarousel: function(options)
		{
			var defaults = 
			{
				...
				easeLeft: 'linear',
				easeRight: 'linear',
				imagePath: 'carousel/js/infinitecarousel/images/',
				inView: 1,
				padding: '0px',
				advance: 1,
				showControls: true,
		...
		var options = $.extend(defaults, options);
			...
			{
				$(obj).append('<div id="textholder'+randID+'_'+i+'" class="textholder" style="position:absolute;padding-left:20px;width:'+imgWidth+'px;bottom:0px;margin-bottom:'+-(imgHeight*o.textholderHeight+containerBorder)+'px;"><span></span></div>');
